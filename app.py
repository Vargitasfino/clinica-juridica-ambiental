...
# ===================== PÁGINA MEDIDAS =====================
    ...
    # Información adicional sobre tecnologías
...
# ===================== PÁGINA NORMATIVAS INTERNACIONALES =====================
    ...
    with tab2:
        ...
        epa_tabla = pd.DataFrame([
            ['PM2.5', '9.0 (P)', '35 (P)', 'μg/m³', '2024'],
            ['PM10', None, '150 (P,S)', 'μg/m³', '2012'],
            ['O3', None, '70 (P,S)', 'ppb', '2015']
    ...
    with tab3:
        ...
        canada_tabla = pd.DataFrame([
            ...
            ['O3', 62, 60, 'ppb', '8h']
        ], columns=['Contaminante', 'Estándar 2020', 'Meta 2025', 'Unidad', 'Forma'])
        
        st.dataframe(canada_tabla, use_container_width=True, hide_index=True)
    
    with tab4:
        st.markdown("<h2 style='text-align: center;'>📊 Comparación PM2.5</h2>", unsafe_allow_html=True)
        
        comparacion = pd.DataFrame([
            {'Entidad': 'OMS 2021', 'Anual': 5},
            {'Entidad': 'EPA USA 2024', 'Anual': 9},
            {'Entidad': 'Canadá 2025', 'Anual': 8},
            {'Entidad': 'OEFA Perú', 'Anual': 25}
        ])
        
        fig = px.bar(comparacion, x='Entidad', y='Anual', text='Anual')
