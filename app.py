...
.tl-scroll::-webkit-scrollbar{height:24px;background:rgba(255,255,255,0.4);border-radius:15px;border:3px solid rgba(255,255,255,0.2);margin-bottom:10px}
.tl-scroll::-webkit-scrollbar-track{background:linear-gradient(180deg,rgba(255,255,255,0.5),rgba(255,255,255,0.6));border-radius:15px;box-shadow:inset 0 0 15px rgba(255,255,255,0.3),0 2px 10px rgba(0,0,0,0.2)}
.tl-scroll::-webkit-scrollbar-thumb{background:#ffffff;border-radius:15px;border:4px solid rgba(255,255,255,0.5);box-shadow:0 0 20px rgba(255,255,255,1),0 0 40px rgba(255,255,255,0.8),inset 0 0 15px rgba(200,230,255,0.5)}
.tl-scroll::-webkit-scrollbar-thumb:hover{background:#ffffff;box-shadow:0 0 30px rgba(255,255,255,1),0 0 50px rgba(255,255,255,1),0 0 70px rgba(0,229,255,0.6);border-color:#ffffff}
.tl-scroll::-webkit-scrollbar-thumb:active{background:#f0f8ff;box-shadow:0 0 40px rgba(255,255,255,1),0 0 60px rgba(255,255,255,1)}
